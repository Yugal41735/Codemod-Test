/**
 * This codemod transforms any instance of LogLuvLoader into UltraHDRLoader, including strings, imports, exports, and instantiations.
 */
...
module.exports = function (fileInfo, api) {
  ...
  root.find(j.NewExpression, { callee: { name: 'LogLuvLoader' } })
    .forEach(path => {
      path.node.callee.name = 'UltraHDRLoader';
    });

  // Replace identifiers and any other usage
  root.find(j.Identifier, { name: 'LogLuvLoader' })
    .forEach(path => {
